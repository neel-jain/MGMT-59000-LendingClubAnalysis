...
COLUMN_LABELS: Dict[str, str] = {
    ...
    "prediction_time_ms_per_1000": "Prediction Time (ms/1000)",
    "memory_usage_kb": "Memory (KB)",
    ...
    # Segment / cluster tables (Borrower Segmentation page)
    "segment_name": "Segment",
    "cluster_id": "Cluster ID",
    "n_borrowers": "Borrowers",
    "pct_of_portfolio": "% of Portfolio",
    "typical_income": "Typical Income",
    "typical_interest_rate": "Typical Interest Rate",
    "typical_loan_grade": "Typical Grade",
    "typical_dti": "Typical DTI",
    "typical_employment_length": "Typical Employment (Yrs)",
    "average_default_rate": "Default Rate",
    "risk_tier": "Risk Tier",
    "mean_predicted_probability": "Predicted Probability",
